...
- 🎯 Entry points to execute your program using `python -m <portfolio_auto_analysis>` or `$ portfolio_auto_analysis` with basic CLI argument parsing.
...
Awesome portfolio_auto_analysis created by WagnoLeaoSergio

## Install it from PyPI

```bash
pip install portfolio_auto_analysis
```

## Usage

```py
from portfolio_auto_analysis import BaseClass
from portfolio_auto_analysis import base_function
...
```bash
$ python -m portfolio_auto_analysis
#or
$ portfolio_auto_analysis
```
